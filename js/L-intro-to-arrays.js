...
var favoriteFoods = ["Bacon", "Chicken", "Steak", "Eggs", "Pizza"];
...
// You exclude whatever values have indexes < i
// TODO: What are benefits of using loops to iterate?
// Quickly pick out specific data
// TODO: How does the loop know when to stop iterating?
// With a For Loop, you declare the endpoint in the condition
// With a ForEach, it iterates through every single item in the array
...
for (var i = 0; i < daysOfTheWeek.length; i++) {
    console.log("The day of the week at index " + i + " is " + daysOfTheWeek[i]);
}
// TODO: Using a for loop, iterate through the favoriteFoods array and console.log each favorite food
for (var i = 0; i < favoriteFoods.length; i++) {
    console.log("The favorite food at index " + i + " is " + favoriteFoods[i]);
}
// TODO: Refactoring the instructor loop, alert "hey, I know <INSTRUCTOR NAME HERE>" if you have had class with that instructor. If you have not had class with that instructor, alert "I haven't had class with <INSTRUCTOR NAME HERE> yet!"
for (var i = 0; i < instructors.length; i++) {
    var hadInstructor = ["David", "Vivian", "Casey"];

    if () {
        alert("Hey, I know " + );
    } else {
        alert("I haven't had class with " + + " yet!");
    }
}

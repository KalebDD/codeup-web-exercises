...
$(document).ready(function() {
    ...
    $('#reduceForEach').html(commaThousands(totalVal));

    /********************************* 2 *********************************/
    //  2. Use reduce()
    let totalValReduce = mbpModels.reduce(function(total, mbp) {
        return total + mbp.price;
    }, 0);
    $('#reduce').html(commaThousands(totalValReduce));
    /********************************* 3 *********************************/
    //  3. Use ES6
    let totalValES6 = mbpModels.reduce((total, mbp) => total + mbp.price, 0);
    $('#reduceEs6').html(commaThousands(totalValES6));
    /**************************** LEAVE IN FOR STUDENTS **(********************************/

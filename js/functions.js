...
(function() {
     ...
     */
    var helloMessage = sayHello("Kaleb");
...
// and stores it in a variable named random
    ...
    var originalPrice = Number(prompt( "What was the item's original price?"));
    var discountPercent = Number(prompt("What is the discount percentage?"));
    var totalWithDiscount = applyDiscount(originalPrice, discountPercent);
    alert("Your total today is: $ " + totalWithDiscount);
})();